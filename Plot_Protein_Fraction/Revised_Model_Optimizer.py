...
class Fibril_Optimization:
    ...
    def save_plot(self, plot_title):
        cur_path = '/project/fava/work/kiersten.ruff/Collaborations/Mittag/2023/ThT_fitting/For_Kiersten/Revised_Eq_Figures/Fitting/'
        filetype = '.pdf'
...
#===============================================================================
# #One-phase regime Day 1
#      
# #file_name = '/project/fava/work/kiersten.ruff/Collaborations/Mittag/2023/ThT_fitting/For_Kiersten/Revised_Eq_Data/Datasets for fitting/Day 1/WT_data.txt'
# #file_name = '/project/fava/work/kiersten.ruff/Collaborations/Mittag/2023/ThT_fitting/For_Kiersten/Revised_Eq_Data/Datasets for fitting/Day 1/D262N_data.txt'
# file_name = '/project/fava/work/kiersten.ruff/Collaborations/Mittag/2023/ThT_fitting/For_Kiersten/Revised_Eq_Data/Datasets for fitting/Day 1/D262V_data.txt'
# free_parameter_checklist = [0, 0, 1, 1, 1, 0, 0, 2, 0, 0, 1]
#     
# #WT less than half csat 
# #initial_guess = [0, 0, 3.79 * 10 ** -10, 4.91 * 10 ** -10, 7.66 * 10 ** 2,
# #                 0.0, 0, 'dilute', 0, 0, 1.28 * 10 ** 2]
#   
# #WT 21 
# #initial_guess = [0, 0, 6.33 * 10 ** -12, 1.23 * 10 ** -9, 2.30 * 10 ** 3,
# #                 0.0, 0, 'dilute', 0, 0, 1.27 * 10 ** 2]
#       
# #D262N less than quarter csat
# #initial_guess = [0, 0, 9.95 * 10 ** -10, 3.92 * 10 ** -9,
# #                 2.18 * 10 ** 3, 2.41 * 10 ** -11, 0, 'dilute', 0, 0, 1.37 * 10 ** 2]
#  
# #D262N 21
# #initial_guess = [0, 0, 4.41 * 10 ** -10, 6.08 * 10 ** -9,
# #                 2.34 * 10 ** 3, 0.0, 0, 'dilute', 0, 0, 1.41 * 10 ** 2]
# 
# #D262V 21
# initial_guess = [0, 0, 5.04 * 10 ** -10, 2.89 * 10 ** -9,
#                  2.04 * 10 ** 3, 0.0, 0, 'dilute', 0, 0, 6.50 * 10 ** 1]
#     
...
#        
# #file_name = '/project/fava/work/kiersten.ruff/Collaborations/Mittag/2023/ThT_fitting/For_Kiersten/Revised_Eq_Data/Datasets for fitting/Day 2/WT_data.txt'
# #file_name = '/project/fava/work/kiersten.ruff/Collaborations/Mittag/2023/ThT_fitting/For_Kiersten/Revised_Eq_Data/Datasets for fitting/Day 2/D262N_data.txt'
# file_name = '/project/fava/work/kiersten.ruff/Collaborations/Mittag/2023/ThT_fitting/For_Kiersten/Revised_Eq_Data/Datasets for fitting/Day 2/D262V_data.txt'
# free_parameter_checklist = [0, 0, 1, 1, 1, 0, 0, 2, 0, 0, 1]
#        
# #WT less than half csat 
# #initial_guess = [0, 0, 5.98 * 10 ** -10, 0.0, 1.22 * 10 ** 3,
# #                 0.0, 0, 'dilute', 0, 0, 1.32 * 10 ** 2]
#   
# #WT 21     
# #initial_guess = [0, 0, 7.15 * 10 ** -12, 9.83 * 10 ** -10, 2.59 * 10 ** 3,
# #                 0.0, 0, 'dilute', 0, 0, 1.18 * 10 ** 2]
#   
# #D262N less than quarter csat
# #initial_guess = [0, 0, 1.78 * 10 ** -9, 0.0,
# #                 4.26 * 10 ** 3, 0.0, 0, 'dilute', 0, 0, 1.59 * 10 ** 1]
#        
# #D262N 21
# #initial_guess = [0, 0, 1.89 * 10 ** -9, 0.0,
# #                 5.24 * 10 ** 3, 0.0, 0, 'dilute', 0, 0, 1.47 * 10 ** 1]
# 
# #D262V 21
# initial_guess = [0, 0, 1.29 * 10 ** -9, 1.35 * 10 ** -9,
#                  4.22 * 10 ** 3, 0.0, 0, 'dilute', 0, 0, 8.47 * 10 ** 1]
#  
# bounds_list = [(0, None)] * 11
#        
# csat_wt = 71.2
...
#===============================================================================
# #Two-phase regime Day 1
#      
# #file_name = '/Users/mina/Desktop/WashU/Pappu Lab/Fibrils/Datasets for fitting/Day 1/WT_data.txt'
# #file_name = '/Users/mina/Desktop/WashU/Pappu Lab/Fibrils/Datasets for fitting/Day 1/D262N_data.txt'
# file_name = '/Users/mina/Desktop/WashU/Pappu Lab/Fibrils/Datasets for fitting/Day 1/D262V_data.txt'
# free_parameter_checklist = [1, 1, 1, 1, 1, 0, 0, 2, 0, 0, 1]
#      
# #WT max concentration
# #initial_guess = [5.13 * 10 ** -3, 6.90 * 10 ** -2, 2.39 * 10 ** -8, 1.14 * 10 ** -6,
# #                 8.06 * 10 ** 1, 0.0, 0, 'dilute', 0, 0, 4.63 * 10 ** 1]
#      
# #D262N max concentration
# #initial_guess = [7.13 * 10 ** -1, 7.01 * 10 ** -1, 4.11 * 10 ** -9, 2.54 * 10 ** -9,
# #                 1.07 * 10 ** 3, 0.0, 0, 'dilute', 0, 0, 3.24 * 10 ** 1]
# 
# #D262V max concentration
# initial_guess = [1.27 * 10 ** 1, 7.13 * 10 ** 0, 8.23 * 10 ** -9, 1.48 * 10 ** -8,
#                  1.42 * 10 ** 2, 0.0, 0, 'dilute', 0, 0, 3.32 * 10 ** 1]
#      
# bounds_list = [(0, None)] * 11
#     
# csat_wt = 71.2
...
#===============================================================================
# #Two-phase regime Day 2
#    
# #file_name = '/Users/mina/Desktop/WashU/Pappu Lab/Fibrils/Datasets for fitting/Day 2/WT_data.txt'
# #file_name = '/Users/mina/Desktop/WashU/Pappu Lab/Fibrils/Datasets for fitting/Day 2/D262N_data.txt'
# file_name = '/Users/mina/Desktop/WashU/Pappu Lab/Fibrils/Datasets for fitting/Day 2/D262V_data.txt'
# free_parameter_checklist = [1, 1, 1, 1, 1, 0, 0, 2, 0, 0, 1]
#    
# #WT max concentration
# #initial_guess = [3.86 * 10 ** -3, 1.25 * 10 ** -2, 9.05 * 10 ** -8, 1.92 * 10 ** -8,
# #                 1.84 * 10 ** 2, 0.0, 0, 'dilute', 0, 0, 5.09 * 10 ** 1]
#    
# #D262N max concentration
# #initial_guess = [9.00 * 10 ** -2, 1.17 * 10 ** -2, 6.03 * 10 ** -9, 5.48 * 10 ** -10,
# #                 1.37 * 10 ** 3, 0.0, 0, 'dilute', 0, 0, 3.84 * 10 ** 1]
#    
# #D262V max concentration
# initial_guess = [1.08 * 10 ** 1, 6.46 * 10 ** -6, 4.71 * 10 ** -8, 7.60 * 10 ** -9,
#                  2.31 * 10 ** 2, 0.0, 0, 'dilute', 0, 0, 3.71 * 10 ** 1]
#  
# bounds_list = [(0, None)] * 11
#   
# csat_wt = 71.2
