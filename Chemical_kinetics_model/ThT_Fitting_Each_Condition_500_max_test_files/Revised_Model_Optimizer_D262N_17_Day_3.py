...
class Fibril_Optimization:
    ...
    def plotter(self, exp_fibril_list, comp_fibril_list):
        ...
        file = open('exp_fibril_D262N_17_Day_3.txt','w') # Change this
        for item in exp_fibril_list:
            file.write(str(item)+"\n")
        file = open('comp_fibril_D262N_17_Day_3.txt','w') # Change this
...
# using thtfit_env        
file_name = '/project/fava/work/kiersten.ruff/Collaborations/Mittag/2023/ThT_fitting/For_Kiersten/Revised_Eq_Data/Datasets for fitting/Day 3/D262N_data.txt'
...
plot_title = 'D262N_17_Day3_plot_through_501'
...
#starting guess
if plot_save==0:
    with open('initial_guess_D262N_17_Day_3.txt') as myfile: # previous concentrations best guess, Change this
        for line in myfile:
            line = line.strip()
            line = line.split(",")
elif plot_save==1:
    with open('best_guess_D262N_17_Day_3.txt') as myfile: # current best fit used to plot, Change this
        for line in myfile:
            line = line.strip()
            line = line.split(",")
...
import csv
if plot_save==0:
    with open('best_guess_D262N_17_Day_3.txt','w') as myoutfile: # Change this
