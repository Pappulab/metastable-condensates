...
class Fibril_Optimization:
    ...
    def plotter(self, exp_fibril_list, comp_fibril_list):
        ...
        file = open('exp_fibril_WT_33_Day_1.txt','w') #Change this
        for item in exp_fibril_list:
            file.write(str(item)+"\n")
        file = open('comp_fibril_WT_33_Day_1.txt','w') #Change this
...
plot_title = 'WT_33_Day1_plot_through_501'
...
#starting guess
if plot_save==0:
    with open('best_guess_WT_26_Day_1.txt') as myfile: # previous concentrations best guess, Change this
        for line in myfile:
            line = line.strip()
            line = line.split(",")
elif plot_save==1:
    with open('best_guess_WT_33_Day_1.txt') as myfile: # current best fit used to plot, Change this
        for line in myfile:
            line = line.strip()
            line = line.split(",")
...
# cur_opt.fit.fun = 4053791.55009912 - update this
...
import csv
if plot_save==0:
    with open('best_guess_WT_33_Day_1.txt','w') as myoutfile: # Change this
