...
class Fibril_Optimization:
    ...
    def plotter(self, exp_fibril_list, comp_fibril_list):
        ...
        file = open('exp_fibril_D262V_26_Day_3.txt','w')
        for item in exp_fibril_list:
            file.write(str(item)+"\n")
        file = open('comp_fibril_D262V_26_Day_3.txt','w')
...
# using thtfit_env        
file_name = '/project/fava/work/kiersten.ruff/Collaborations/Mittag/2023/ThT_fitting/For_Kiersten/Revised_Eq_Data/Datasets for fitting/Day 3/D262V_data.txt'
...
plot_title = 'D262V_26_Day3_plot_through_501'

# For initial optimization  
#time_cutoff = 333 # use value from plot_exp_ThT - Change this
#plot_check = 0
#plot_save = 0
...
#starting guess
if plot_save==0:
    #with open('best_guess_D262V_21_Day_3.txt') as myfile: # previous concentrations best guess, Change this
    with open('initial_guess_D262V_26_Day_3.txt') as myfile: # previous concentrations best guess, Change this
        for line in myfile:
            line = line.strip()
            line = line.split(",")
elif plot_save==1:
    with open('best_guess_D262V_26_Day_3.txt') as myfile: # current best fit used to plot, Change this
        for line in myfile:
            line = line.strip()
            line = line.split(",")
...
# cur_opt.fit.fun = 3224144.2290561404
...
import csv
if plot_save==0:
    with open('best_guess_D262V_26_Day_3.txt','w') as myoutfile: # Change this
