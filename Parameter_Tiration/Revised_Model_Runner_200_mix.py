...
counter = 0
for den_dil in [0.001, 0.002, 0.005, 0.01, 0.02, 0.05, 0.1, 0.2, 0.5, 1, 2, 5, 10, 20, 50]:
    for dil_den in [0.001, 0.002, 0.005, 0.01, 0.02, 0.05, 0.1, 0.2, 0.5, 1, 2, 5, 10, 20, 50]:

        print(counter)
        
        k_dense_dilute = den_dil
        k_dilute_dense = dil_den
        k_dilute_fibril_primary = 1e-08
        k_dilute_fibril_secondary = 5e-09
        k_fibril_elongation = 500
        k_fibril_loss = 0
...
cur_df.to_excel('Data_kdil_kden_titration/Parameters_200_mix_equil_0.xlsx', sheet_name='Reference')
