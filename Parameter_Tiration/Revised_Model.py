...
class Fibril_Model:
    ...
    def ax_filler(self, ax, fibril_check=False, fibril_full_check=False):
    ...
    def plotter(self, fibril_check = False, fibril_full_check = False):
        ...
        self.ax_filler(self.ax_matrix[0], fibril_check, fibril_full_check)
        plt.tight_layout()
